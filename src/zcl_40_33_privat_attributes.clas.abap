CLASS zcl_40_33_privat_attributes DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_40_33_privat_attributes IMPLEMENTATION.
...
*    hotel = NEW #(  ).                                " Dieses Hotel wird im Counter nicht mit aufgenommen, er durchläuft kein set-attributes
*
